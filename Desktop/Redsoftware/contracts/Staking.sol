...
contract Staking{
    ...
    function modifyLockPeriods(uint numDays, uint basisPoints) external {
        require(owner == msg.sender,"only owner can modify staking period");
    ...
    function closePosition(uint positionId) external {
        require(positions[positionId].walletAddress == msg.sender,'Only position creator may modify the position');
